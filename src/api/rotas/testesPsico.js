...
module.exports = function(server) {
    ...
    //READ ALL
    var sql = 'SELECT * FROM testespsico'
    router.get('/testesPsico', (req, res) => {execSQLQuery(sql, res)})

    var sqlPadrao = 'SELECT * FROM testespsico where padrao = "sim"'
    router.post('/examesPadrao',(req, res) => {execSQLQuery(sqlPadrao, res)})
